...
export default function SobreNosotros() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <h1 className={`text-4xl font-bold text-purple-700 ${styles.typingAnimation}`}>Sobre Nosotros</h1>
      </section>
      ...
      <section className="flex flex-col grow min-w-full py-3 px-4">
        <div className="flex flex-row gap-4">
          <div className="w-1/2 flex flex-col rounded-xl shadow-lg p-6 gap-4">
            ...
            <p className={`text-gray-700 mb-4 ${styles.fadeInUp}`}>
          ...
          <div className={"w-1/2 flex rounded-xl bg-neutral-200 items-center justify-center relative"}>
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 rounded-xl">
              <div className="text-white text-center">
                <h3 className={`text-4xl font-bold ${styles.fadeInUp}`}>¡Únete a Nosotros!</h3>
